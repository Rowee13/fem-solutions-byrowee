...
const FemProductCard = () => {
  return (
    <div className="flex relative bg-fem-01 h-full md:h-screen w-screen justify-center items-center py-24 lg:py-0 text-gray-900 overflow-hidden">
      {/* == challenge solution == */}
      <main className="flex flex-col lg:flex-row bg-slate-50 w-full md:w-1/2 lg:w-8/12 xl:w-1/2 h-11/12 lg:h-[500px] m-5 rounded-2xl font-montserrat">
        ...
        <div className="flex flex-col lg:w-1/2 h-full p-6 lg:p-8 justify-between">
          <div className="flex flex-col space-y-6">
            <h4 className="uppercase text-base tracking-[0.4rem]">Perfume</h4>
            <h1 className="font-black text-4xl font-fraunces lg:w-4/5">
          ...
          <div className="flex flex-col space-y-6 pt-6">
            ...
            <button className="flex flex-row justify-center items-center gap-3 w-full h-14 py-2 rounded-xl text-slate-50 font-bold bg-fem-01-light hover:bg-fem-01-dark ">
      ...
      {/* == credits == */}
      <div className="absolute bottom-4 md:bottom-10 text-xs text-center">
        <p>
          Challenge by{" "}
          <a
